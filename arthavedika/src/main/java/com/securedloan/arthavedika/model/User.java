...
//	}
	...
	public User(@NotNull String user_id, @NotNull String firstname, @NotNull String lastname, @NotNull String email_id,
			@NotNull String mobile_no, @NotNull String password, @NotNull boolean loggedIn, @NotNull boolean verified,
			@NotNull boolean admin, @NotNull boolean bc_agent, @NotNull String companyName, String otp,
